...
class _KeysState extends State<Keys> {
  ...
  // Sorting
  // text is a property of _todo class
  List<Todo> get _orderedTodos {
    final sortedTodos = List.of(_todos); //copying
    sortedTodos.sort((a, b) {
      int bComesAfterA = a.text.compareTo(b.text); // ascending
  ...
  void _changeOrder() {
    setState(() {
      _order = _order == 'asc' ? 'desc' : 'asc'; // asc to desc or vice versa
    });
  }
